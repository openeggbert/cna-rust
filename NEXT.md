...
UNREVIEWED=142               # was 416
ACTIONABLE_LOCAL=0

RUST_SYS_DECLARATIONS=3114
SYMBOL_ACQUISITIONS=3078
LINKED_DECLARATIONS=3114
...
WORKSPACE_TEST_FILES=41
WORKSPACE_TEST_FUNCTIONS=188
...
Seven headers now stand at zero undecided routes: `graphics_resource.h`,
`input.h`, `input_keyboard.h`, `input_mouse.h`, `texture.h`, `runtime.h` and
`content.h`.
...
1. **The remaining 142 undecided routes.** `content_readers.h` (35),
   `video.h` (12), `xact.h` (11), `audio.h` (11), `media.h` (9),
   `vertex_resources.h` (7), `input_joystick.h` (6), `graphics.h` (6) and a
   long tail. Each needs the same treatment the families above got: read what
