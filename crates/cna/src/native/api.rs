...
pub(crate) struct Native {
    ...
    pub(crate) gamepad_copy_guid_ext: sys::cna_gamepad_copy_guid_ext_fn,
    pub(crate) gamepad_copy_name_ext: sys::cna_gamepad_copy_name_ext_fn,
    pub(crate) gamepad_copy_path_ext: sys::cna_gamepad_copy_path_ext_fn,
    pub(crate) gamepad_copy_serial_ext: sys::cna_gamepad_copy_serial_ext_fn,
    pub(crate) gamepad_exclude_axis_dead_zone: sys::cna_gamepad_exclude_axis_dead_zone_fn,
    pub(crate) gamepad_get_accelerometer_ext: sys::cna_gamepad_get_accelerometer_ext_fn,
    pub(crate) gamepad_get_button_label_ext: sys::cna_gamepad_get_button_label_ext_fn,
    pub(crate) gamepad_get_connection_state_ext: sys::cna_gamepad_get_connection_state_ext_fn,
    pub(crate) gamepad_get_firmware_version_ext: sys::cna_gamepad_get_firmware_version_ext_fn,
    pub(crate) gamepad_get_guid_size_ext: sys::cna_gamepad_get_guid_size_ext_fn,
    pub(crate) gamepad_get_gyro_ext: sys::cna_gamepad_get_gyro_ext_fn,
    pub(crate) gamepad_get_name_size_ext: sys::cna_gamepad_get_name_size_ext_fn,
    pub(crate) gamepad_get_path_size_ext: sys::cna_gamepad_get_path_size_ext_fn,
    pub(crate) gamepad_get_player_index_ext: sys::cna_gamepad_get_player_index_ext_fn,
    pub(crate) gamepad_get_power_info_ext: sys::cna_gamepad_get_power_info_ext_fn,
    pub(crate) gamepad_get_serial_size_ext: sys::cna_gamepad_get_serial_size_ext_fn,
    pub(crate) gamepad_get_steam_handle_ext: sys::cna_gamepad_get_steam_handle_ext_fn,
    pub(crate) gamepad_get_touchpad_count_ext: sys::cna_gamepad_get_touchpad_count_ext_fn,
    pub(crate) gamepad_get_touchpad_finger_count_ext: sys::cna_gamepad_get_touchpad_finger_count_ext_fn,
    pub(crate) gamepad_get_touchpad_finger_ext: sys::cna_gamepad_get_touchpad_finger_ext_fn,
    pub(crate) gamepad_set_light_bar_ext: sys::cna_gamepad_set_light_bar_ext_fn,
    pub(crate) gamepad_set_player_index_ext: sys::cna_gamepad_set_player_index_ext_fn,
    pub(crate) gamepad_set_trigger_vibration_ext: sys::cna_gamepad_set_trigger_vibration_ext_fn,
...
impl Native {
    ...
    fn from_source(source: NativeSource) -> Result<Self> {
        ...
        Ok(Self {
            ...
            gamepad_copy_guid_ext: symbol!(cna_gamepad_copy_guid_ext, sys::cna_gamepad_copy_guid_ext_fn),
            gamepad_copy_name_ext: symbol!(cna_gamepad_copy_name_ext, sys::cna_gamepad_copy_name_ext_fn),
            gamepad_copy_path_ext: symbol!(cna_gamepad_copy_path_ext, sys::cna_gamepad_copy_path_ext_fn),
            gamepad_copy_serial_ext: symbol!(cna_gamepad_copy_serial_ext, sys::cna_gamepad_copy_serial_ext_fn),
            gamepad_exclude_axis_dead_zone: symbol!(cna_gamepad_exclude_axis_dead_zone, sys::cna_gamepad_exclude_axis_dead_zone_fn),
            gamepad_get_accelerometer_ext: symbol!(cna_gamepad_get_accelerometer_ext, sys::cna_gamepad_get_accelerometer_ext_fn),
            gamepad_get_button_label_ext: symbol!(cna_gamepad_get_button_label_ext, sys::cna_gamepad_get_button_label_ext_fn),
            gamepad_get_connection_state_ext: symbol!(cna_gamepad_get_connection_state_ext, sys::cna_gamepad_get_connection_state_ext_fn),
            gamepad_get_firmware_version_ext: symbol!(cna_gamepad_get_firmware_version_ext, sys::cna_gamepad_get_firmware_version_ext_fn),
            gamepad_get_guid_size_ext: symbol!(cna_gamepad_get_guid_size_ext, sys::cna_gamepad_get_guid_size_ext_fn),
            gamepad_get_gyro_ext: symbol!(cna_gamepad_get_gyro_ext, sys::cna_gamepad_get_gyro_ext_fn),
            gamepad_get_name_size_ext: symbol!(cna_gamepad_get_name_size_ext, sys::cna_gamepad_get_name_size_ext_fn),
            gamepad_get_path_size_ext: symbol!(cna_gamepad_get_path_size_ext, sys::cna_gamepad_get_path_size_ext_fn),
            gamepad_get_player_index_ext: symbol!(cna_gamepad_get_player_index_ext, sys::cna_gamepad_get_player_index_ext_fn),
            gamepad_get_power_info_ext: symbol!(cna_gamepad_get_power_info_ext, sys::cna_gamepad_get_power_info_ext_fn),
            gamepad_get_serial_size_ext: symbol!(cna_gamepad_get_serial_size_ext, sys::cna_gamepad_get_serial_size_ext_fn),
            gamepad_get_steam_handle_ext: symbol!(cna_gamepad_get_steam_handle_ext, sys::cna_gamepad_get_steam_handle_ext_fn),
            gamepad_get_touchpad_count_ext: symbol!(cna_gamepad_get_touchpad_count_ext, sys::cna_gamepad_get_touchpad_count_ext_fn),
            gamepad_get_touchpad_finger_count_ext: symbol!(cna_gamepad_get_touchpad_finger_count_ext, sys::cna_gamepad_get_touchpad_finger_count_ext_fn),
            gamepad_get_touchpad_finger_ext: symbol!(cna_gamepad_get_touchpad_finger_ext, sys::cna_gamepad_get_touchpad_finger_ext_fn),
            gamepad_set_light_bar_ext: symbol!(cna_gamepad_set_light_bar_ext, sys::cna_gamepad_set_light_bar_ext_fn),
            gamepad_set_player_index_ext: symbol!(cna_gamepad_set_player_index_ext, sys::cna_gamepad_set_player_index_ext_fn),
            gamepad_set_trigger_vibration_ext: symbol!(cna_gamepad_set_trigger_vibration_ext, sys::cna_gamepad_set_trigger_vibration_ext_fn),
